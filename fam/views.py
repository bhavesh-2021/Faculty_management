...
from .models import faculty,Education,Teaching,Publication,Projects,Achievements, Application, Schedule, Post, Comment, Attendance
...
def attendance(request):
    ...
    context['user'] = request.user
    context['faculty'] = faculty.objects.all()
    context['attendance'] = Attendance.objects.filter(user = request.user.id)
    if request.user.is_authenticated:
